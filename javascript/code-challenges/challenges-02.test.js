...
const forEachTwoToThe = (arr) => {
  ...
  arr.forEach(value => newArr4.push(Math.pow(2, value)));
...
const extractStats = (arr) => {
  ...
  return arr.map(ability => {
    return {name: ability.stat.name, total: ability.effort + ability.baseStat};
  });
};
